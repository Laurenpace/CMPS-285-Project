...
namespace StarterProject.Api.Migrations
{
    ...
    [Migration("20190308205007_AddTable_Schedule")]
    partial class AddTable_Schedule
    {
            ...
            modelBuilder.Entity("StarterProject.Api.Features.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 126, 15, 162, 2, 115, 106, 240, 87, 194, 192, 178, 71, 246, 250, 13, 108, 135, 45, 197, 25 },
                            PasswordSalt = new byte[] { 43, 64, 218, 231, 164, 181, 232, 250, 141, 48, 143, 181, 200, 19, 77, 170 },
                            Role = "Admin",
                            Username = "admin"
                        });
                });
